...
CREATE TABLE `playrecord` (
  ...
  `hoursplayed` int DEFAULT NULL,
  `progress` varchar(45) DEFAULT NULL,
  `notes` varchar(90) DEFAULT NULL,
  PRIMARY KEY (`iduser`,`idgame`,`idplatform`),
  KEY `fk_idgame_idx` (`idgame`),
  KEY `fk_idplatform_idx` (`idplatform`),
  CONSTRAINT `fk_idgame` FOREIGN KEY (`idgame`) REFERENCES `game` (`idgame`),
  CONSTRAINT `fk_idplatform` FOREIGN KEY (`idplatform`) REFERENCES `platform` (`idplatform`),
